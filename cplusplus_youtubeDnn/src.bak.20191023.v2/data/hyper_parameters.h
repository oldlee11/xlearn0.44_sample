...
//------------------------------------------------------------------------------
  ...
  bool quiet = false;
  /* Score function. 
  For now, it can be 'youtubeDnn' */
  std::string score_func = "youtubeDnn";
  /* Loss function. 
...
//------------------------------------------------------------------------------
  ...
  bool isjustloadembedding=true;    // =true 表示仅仅初始化embedding  用于第一次训练   =fales  表示 re_trainning
